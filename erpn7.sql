...
CREATE TABLE O_PURCHASECOMMOM(
  ...
  ALTER TABLE O_PURCHASECOMMOM ADD CONSTRAINT O_PURCHASECOMMOM_FK FOREIGN KEY(P_CLCODE,P_CCODE) REFERENCES AC_COMPANYLIST(CL_CODE,CL_CCODE)
);
...
CREATE TABLE O_PURCHASEPROGRAMCOMMOM(
  ...
  P_APCODE1   NVARCHAR2(20)  NOT NULL, --결재코드1,2,3
  P_APCODE2   NVARCHAR2(20)  NOT NULL, 
  P_APCODE3   NVARCHAR2(20)  NOT NULL   
