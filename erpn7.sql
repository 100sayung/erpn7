...
CREATE TABLE COMPANY(
  ...
  C_NAME NVARCHAR2(30) NOT NULL, -- 회사 이름
  C_CEO NVARCHAR2(10) NOT NULL, --대표자 이름
  C_PHONENUM NVARCHAR2(11) NOT NULL, --회사 번호
  C_KIND NVARCHAR2(20) NOT NULL, --업태
  C_KIND2 NVARCHAR2(20) NOT NULL, --종류
  C_ADDR NVARCHAR2(50) NOT NULL, --회사 주소
  C_VALUE NVARCHAR2(20) NOT NULL, --이거 뭔지 모르겠는데 만든사람 주석 추가 부탁
  C_MONEY NUMBER(15, 0) NOT NULL, --이것도
  CONSTRAINT C_CODE_PK PRIMARY KEY (C_CODE)
);
--회사없이 가입할경우 기본값 입력되기 위한 더미데이터(홈페이지 회사) 테스트하려고 등록한거임
INSERT INTO COMPANY
...
CREATE TABLE AC_COMPANYLIST(
  CL_CODE NVARCHAR2(20) NOT NULL, -- 거래처회사코드
  CL_CCODE NVARCHAR2(20) NOT NULL, -- !!내! 회사코드
  CL_NAME NVARCHAR2(20) NOT NULL, -- 거래처이름
