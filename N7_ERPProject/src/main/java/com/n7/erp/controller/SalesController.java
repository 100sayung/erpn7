...
public class SalesController {
   ...
   public  Map<String, List<A_company>> searchcode(@RequestBody A_company ac) {
	   Map<String, List<A_company>> aMap=sm.searchcode(ac);
	   return aMap;
   }
...
//   @PostMapping(value = "/addApproval",produces="application/json;charset=utf-8" )
...
//      return sMap;
//   }
//   @PostMapping(value = "/approLinecom",produces="application/json;charset=utf-8")
...
//      Map<String, List<approvalLine>> sMap=sm.approLinecom(code01, code02);
//      return sMap;
//   }
...
//   }
   ...
   public ModelAndView approvalinput(approvaldetail app) {
	  System.out.println("슈밤111111");
	  mav=sm.approvalinput(app);
      return mav;
   }
  
	@PostMapping(value = "sales/uncollectedmoneyinput", produces = "application/json;charset=utf-8") // 미수금 등록
	public ModelAndView uncollectedmoneyinput(approvaldetail ap) {
		System.out.println("들어가닝");
		mav = sm.uncollectedmoneyinput(ap);
		return mav;
	}
   ...
   public ModelAndView businessactivitiesinput(Businessbean b) {
	   System.out.println("슈댕");
	   mav=sm.businessactivitiesinput(b);
	   return mav;
   }
