...
CREATE TABLE S_CATEGORY(
  ...
  CONSTRAINT S_CATEGORY_PK PRIMARY KEY (CT_CODE, CT_CCODE),
  CONSTRAINT S_CATEGORY_FK FOREIGN KEY (CT_CCODE) REFERENCES COMPANY (C_CODE)
);
...
CREATE TABLE AC_JNOB(
  J_CODE NVARCHAR2(20) NOT NULL, --전표코드
  J_CCODE NVARCHAR2(20) NOT NULL,
  J_DOCUNUM NVARCHAR2(10) NOT NULL, --문서번호
  ...
  CONSTRAINT AC_JNOB_PK PRIMARY KEY (J_CODE, J_CCODE, J_DOCUNUM),
