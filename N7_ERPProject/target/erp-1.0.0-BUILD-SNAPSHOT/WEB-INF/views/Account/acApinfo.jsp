	...
	<form id="fo">
		...
		<div
			...
			<table>
				...
				<tr>
					<th>결재자</th>
					<th id="line"><input type="hidden" value="${ac.j_none}"
						name="j_none">결재자1: ${ac.j_none} || <input type="hidden"
						value="${ac.j_ntwo}" name="j_ntwo">결재자2: ${ac.j_ntwo} || <input
						type="hidden" value="${ac.j_nthr}" name="j_nthr">결재자3:${ac.j_nthr}
					</th>
