...
CREATE TABLE B_UNCOLLECTEDMONEY(
  ...
  BU_ITCODE NVARCHAR2(20) NOT NULL,
  BU_PERSON NVARCHAR2(20) NOT NULL,
  BU_DATE DATE DEFAULT SYSDATE,
  BU_UNIT NUMBER(15,0) NOT NULL,
  BU_QUANTITY NUMBER(15,0) NOT NULL,
  BU_PRICE NUMBER(15,0) NOT NULL,

  CONSTRAINT B_UNCOLLECTEDMONEY_PK PRIMARY KEY (BU_CCODE, BU_CLCODE),
  CONSTRAINT B_UNCOLLECTEDMONEY_FK1 FOREIGN KEY (BU_CCODE) REFERENCES B_ORDER (BO_CCODE),
