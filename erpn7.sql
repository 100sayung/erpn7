...
SELECT O_PURCHASELIST.*,O_PURCHASECOMMOM.P_CLCODE  
FROM O_PURCHASELIST JOIN O_PURCHASECOMMOM 
ON O_PURCHASELIST.P_DOCUMENTCODE = O_PURCHASECOMMOM.P_DOCUMENTCODE; --구매 VIEW
