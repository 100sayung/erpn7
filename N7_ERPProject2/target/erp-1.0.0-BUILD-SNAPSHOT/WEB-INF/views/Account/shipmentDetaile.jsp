...
console.log(sList);
  ...
  $("#testTable").html("");
	...
	console.log(qty);
		...
		str += "<td><input class='data type='text' name='s_price2' value="+price2+" readonly></td>";
		str += "<td><input class='data type='text' name='s_tax' value="+tax+" readonly></td>";
		str += "<td><input class='data type='text' name='s_total' value="+sList[i].ie_price+" readonly></td>";
