			...
			<table id="main2">
				<thead>
					...
					<tr id="company">
						...
						<td><input id="comname" class="data" type="text" name="s_company" /></td>
						<td>사업자번호</td>
						<td><input id="comnum" class="data" type="text" name="s_comnum" /></td>
						<td>입력자</td>
...
function shipmentDetaile(){
	...
	$("input[name='checknum']:checked").each(function() {
		...
		container = $("input[name='checknum']:checked");
