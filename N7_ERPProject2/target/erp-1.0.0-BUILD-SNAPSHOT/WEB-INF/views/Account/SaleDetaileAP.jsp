...
<h2>매입 상세정보</h2>
	...
	<div id="grafe">
		<table id="grafeInfo" style="border: 1px solid;">
			...
			<tr><td><span>품목 밑을 클릭하시면 그래프로 평균단가가 표시됩니다.</span></td><td colspan="2"><span style="color:red;">레드</span>는 불이익<br><span style="color:blue;">블루</span>는 이익</tr>
		</table>
	</div>
	</div>
</body>
...
$.ajax({
	...
	success:function(data){
		...
		for(var i in data.sList){
			if(data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			yearprice+=Number(data.sList[i].s_price);
				
			}
			
			if(data.sList2[i].s_date.substring(5,7)=="01" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr1.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="02" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr2.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="03" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr3.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="04" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr4.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="05" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr5.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="06" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr6.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="07" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr7.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="08" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr8.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="09" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr9.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="10" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr10.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="11" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
			arr11.push(Number(data.sList[i].s_price));
			}else if(data.sList2[i].s_date.substring(5,7)=="12" && data.sList2[i].s_date.substring(0,4)==yearnum && data.sList2[i].s_num.substring(0,2)=="AP"){
