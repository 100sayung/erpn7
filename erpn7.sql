...
--구매 결재 상세
CREATE TABEL O_PURCHASEPROGRAM(
  P_DOCUMENTCODE NVARCHAR2(10) NOT NULL, --구매번호(겸 문서번호)
  P_NAME NAVRCHAR2(20) NOT NULL,
  P_ITCODE NAVRCHAR2(20) NOT NULL,
  P_UNLIT NUMBER(15,0) NOT NULL,
  P_AMOUNT NUMBER(10,0) NOT NULL,
  P_BUDGET NUMBER(15, 0) NOT NULL,
  CONSTRAINT O_PURCHASEPROGRAMCOMMOM_FK FOREIGN KEY (P_DOCUMENTCODE, P_CCODE) REFERENCES O_PURCHASEPROGRAM (P_DOCUMENTCODE, P_CCODE)
